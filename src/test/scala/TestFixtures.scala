...
object TestFixtures {
  ...
  val whileEval = Cell(r -> x * y, y -> 0 ) // TODO: check this. how do i handle vars?
  ...
  val condEval = Cell(Map(r -> r + x, y -> y + 1 ))
